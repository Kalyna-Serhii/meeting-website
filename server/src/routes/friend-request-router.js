...
import { senderFriendRequestValidation, receiverFriendRequestValidation, handleValidationErrors } from '../utils/index.js'
...
router.post('/send-friend-request', authMiddleware.onlyAuthorized, receiverFriendRequestValidation, handleValidationErrors, friendRequestController.sendFriendRequest);
router.post('/cancel-friend-request', authMiddleware.onlyAuthorized, receiverFriendRequestValidation, handleValidationErrors, friendRequestController.cancelFriendRequest);
